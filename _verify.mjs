...
checks.push(
  ...
  ["index.html 含置顶诊断条", ix.includes('id="diag-bar"') && ix.includes('id="diag-log"')],
  ["置顶诊断条是 #main 的第一个子节点",
    ix.indexOf('id="diag-bar"') < ix.indexOf('class="toolbar"')],
  ["styles.css 含诊断条样式", cs.includes(".diag-bar") && cs.includes(".diag-log")],
  ...
  ["app.js 含存储诊断面板", ap.includes("m-diag")],
